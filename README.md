...
Upload an MP4 route video, OCR the HUD coordinates, and render the extracted route as an interactive Three.js path. 1080p (1920x1080) videos are recommended.
...
The app accepts MP4 videos. 1080p (1920x1080) videos are recommended. Optional Railway variables:
